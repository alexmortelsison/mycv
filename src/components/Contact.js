...
const Contact = () => {
  return (
    <div className="text-center">
      <div className="rounded-3xl border m-4 flex flex-col border-indigo-500 shadow-2xl shadow-teal-600 p-2 md:px-10 pt-10 md:m-10 text-center">
        ...
        <div className="flex mt-10 items-center text-center">
          ...
          <h2 className="font-rubik text-xl md:text-2xl text-white font-bold ml-8">
            +8170 3363 2542
          </h2>
        </div>
